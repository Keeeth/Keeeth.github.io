...
* **Tools:** VS Code, Git, GitHub, Formspree API integration.
* **Enterprise IT:** Oracle Simphony POS, Database Management, and IT Support.

### 🌱 Currently Learning
* Completing the **IBM Front-End Development** professional certificate.
* Transitioning vanilla components into **React**.
